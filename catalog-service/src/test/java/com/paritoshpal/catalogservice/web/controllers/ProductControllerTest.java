...
import com.paritoshpal.catalogservice.AbstractIT;
...
class ProductControllerTest extends AbstractIT {
    ...
    void shouldReturnProductByCode(){
        ...
        assertEquals("Winning will make you famous. Losing means certain death...",product.description());
        assertEquals(new BigDecimal("34.0"),product.price());
    }
